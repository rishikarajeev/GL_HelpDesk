...
function SideBar() {
  const [activeIcon, setActiveIcon] = useState("tick"); // Set the initial active icon
  ...
  return (
    <Navbar expand="lg" variant="dark" className=" p-3  h-100">
      ...
      <Navbar.Collapse id="sidebar">
        ...
        <Navbar.Brand href="#home" className="mb-5"> <img src={logo} alt="Home Icon" className="icon" /></Navbar.Brand>
