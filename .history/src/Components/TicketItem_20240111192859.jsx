    ...
    <Container fluid className="p-2">
      <Row>
        ...
        <Col xl={2}>
          <Row>
            <Dropdown >
              <Dropdown.Toggle variant="outline-secondary" id="dropdown-basic" className="custom-dropdown-width">
               High
              </Dropdown.Toggle>
            ...
            <Dropdown>
              <Dropdown.Toggle variant="outline-secondary" id="dropdown-basic" style={{ width: '150px' }}>
               Open
              </Dropdown.Toggle>
