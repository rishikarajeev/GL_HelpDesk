    ...
    <Container >
      <Row className=" mt-3 mb-2  ">
        ...
        <Col className="d-none d-lg-block">
          <div class="form-check form-switch ms-0 d-flex align-items-left">
          <label
        ...
        <Col className="d-none d-lg-block " xs={3}>
          ...
          <button
            className="btn btn-outline-secondary btn-sm dropdown-toggle bg-white me-2 ms-5 "
            type="button"
        ...
        <Col className="text-end d-none d-lg-block" xs={4}>
          <img
            src={search_icon}
            alt="Local Icon"
