  ...
  return (
    <Container>
      <Row className=" mt-3 mb-2  ">
        ...
        <Col xs={4} className="text-end  d-lg-block">
            ...
            <Button variant="btn btn-outline-secondary bg-white " style={{ width: '150px' }}>
        ...
        <Col xs={4} className="text-end d-none d-lg-block">
          <img
            src={search_icon}
            alt="Local Icon"
