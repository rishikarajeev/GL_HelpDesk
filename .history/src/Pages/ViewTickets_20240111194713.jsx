  ...
  return (
    <Container fluid>
      <Row className=" mt-3  ms-2  ">
        ...
        <Col lg={3} className="d-none d-lg-block text-start">
          ...
          <Row>
            <Col className="col-auto">
              <Image
                src={delete_icon}
                alt="Local Icon"
                className="img-thumbnail  p-2 bg-white "
                
              />
            </Col>
            <Col className="mx-0 p-0 g-0 col-auto">
              <Dropdown>
                <Dropdown.Toggle
        ...
        <Col lg={} className="text-end d-none d-lg-block ">
          <Row className="text-end">
          <Col className="col-auto mx-0 p-0">
          <Image
            src={search_icon}
            alt="Local Icon"
            className="img-thumbnail  p-2 bg-white"
        ...
        <Col className="mx-0 p-0 g-0 col-auto">
            <Dropdown>
              <Dropdown.Toggle
                variant="outline-secondary"
                className="bg-white custom-dropdown-width"
                id="dropdown-basic"
