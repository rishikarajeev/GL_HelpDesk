...
function ViewTickets() {
  ...
  <Col className=" col-4 d-none d-lg-block p-0 justify-content-evenly">
  ...
  <Col className=" col-4 d-none d-lg-block p-0 y">
    <Image
      src={delete_icon}
      alt="Local Icon"
  ...
  <Col className=" col-4 text-end d-none d-lg-block p-0">
    <img
      src={search_icon}
      alt="Local Icon"
