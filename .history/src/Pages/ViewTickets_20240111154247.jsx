...
function ViewTickets() {
  ...
  <Col className="d-none d-lg-block p-0 justify-content-evenly">
    <div className="form-check form-switch ms-0 d-flex align-items-start">
      <label className="form-check-label small me-5 p" htmlFor="flexSwitchCheckDefault">
